/* project04.c
 * 01/19/2026
 * Modify the poker.c program to have it recognize an 
 * additional category; royal flush.
 */
...
/*********************************************************
 * main: Calls read_cards, analyze_hand and print result *
 *       repeatedly.                                     *
 *********************************************************/
int main(void)
{
 ...
 *               straight, a dlush, four-of-a-kind,       *
